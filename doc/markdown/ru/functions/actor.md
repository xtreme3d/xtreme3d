...
Некоторые модели содержат смещение скелета в анимации ходьбы. Данная функция устраняет это смещение.
...
Некоторые модели хранят абсолютные значения вращения у костей скелета. Данная функция удаляет этот компонент, делая кадры анимации пригодными для смешивания.
