...
uses Dialogs, Graphics, Classes, SysUtils, 
     ...
     GLTexture, PersistentClasses, GLGraphics, OpenGL1x;
...
type
    ...
    TGLCSMVectorFile = class(TVectorFile)
    public
...
class function TGLCSMVectorFile.Capabilities: TDataFileCapabilities;
begin
  Result := [dfcRead];
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        GetBitmap32(0).Assign(csm.lightmaps[i].bitmap);
        NotifyChange(self);
      end;
