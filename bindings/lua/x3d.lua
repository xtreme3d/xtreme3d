...
ffi.cdef[[
    ...
    double EngineRootObject();
    double EngineShowLoadingErrors(double);
    double EngineSetMaxLights(double);
    double EngineGetTimeStep();
    // fbo.pas
    double FBOCreate(double, double, double);
    double FBOSetCamera(double, double);
    double FBORenderObject(double, double);
    double FBORenderObjectEx(double, double, double, double, double, double);
    double FBOSetViewer(double, double);
    double FBOSetOverrideMaterial(double, double, char*);
    double FBOSetColorTextureFormat(double, double);
    // firefx.pas
    double FireFXManagerCreate();
    ...
    double TTFontSetEncoding(double, double);
    double TTFontLoadCodePage(double, char*);
    // fps.pas
    double FpsManagerCreate();
    ...
    double MouseGetPositionX();
    double MouseGetPositionY();
    ...
    double MaterialAddTextureEx(char*, char*);
    double MaterialTextureExClear(char*);
    double MaterialTextureExDelete(char*, double);
    ...
    double MaterialLoadTextureEx(char*, char*, double);
    double MaterialSetTextureEx(char*, char*, double);
    double MaterialGenTextureEx(char*, double, double, double);
    double MaterialEnableTextureEx(char*, double, double);
    ...
    double MaterialCullFrontFaces(char*, double);
    double MaterialSetZWrite(char*, double);
    double MaterialSetTextureExFromLibrary(char*, double, char*, double);
    ...
    double ObjectGetCollisionPosition(double);
    double ObjectGetCollisionNormal(double);
    ...
    double ObjectHashGetItem(double, char*);
    double ObjectHashDeleteItem(double, char*);
    double ObjectHashGetItemCount(double);
    double ObjectHashClear(double);
    double ObjectHashDestroy(double);
    // ode.pas
    double OdeManagerCreate();
    double OdeManagerDestroy();
    double OdeManagerStep(double);
    double OdeManagerGetNumContactJoints();
    ...
    double OdeManagerSetGeomColor(double);
    ...
    double OdeDynamicGetContactCount(double);
    double OdeStaticGetContactCount(double);
    ...
    double OdeAddCone(double, double, double, double, double, double);
    ...
    double OdeAddJointBall();
    double OdeAddJointFixed();
    double OdeAddJointHinge();
    double OdeAddJointHinge2();
    double OdeAddJointSlider();
    double OdeAddJointUniversal();
    ...
    double OdeRagdollDummyJointCreate();
    ...
    // polygon.pas
    double PolygonCreate(double);
    double PolygonAddVertex(double, double, double, double);
    double PolygonSetVertexPosition(double, double, double, double, double);
    double PolygonDeleteVertex(double, double);
    // primitives.pas
    ...
    double ShadowMapSetCaster(double, double);
    double ShadowMapSetProjectionSize(double, double);
    double ShadowMapSetZScale(double, double);
    double ShadowMapSetZClippingPlanes(double, double, double);
    double ShadowMapRender(double);
    ...
    double SpriteNoZWrite(double, double);
    ...
    // text.pas
    char* TextRead(char*);
    char* TextConvertANSIToUTF8(char*);
    // thorfx.pas
    double ThorFXManagerCreate();
    ...
    double TreeSetMaterials(double, char*, char*, char*);
    ...
    double ViewerRenderToFilePNG(double, char*);
    double ViewerRenderEx(double, double, double, double, double);
    ...
    double ViewerSetOverrideMaterial(double, double, char*);
    ...
    double WindowDispatch();
]]

local x3d = ffi.load("xtreme3d.dll")
