function dll_init(dll) {
	...
	global._CameraZoomAll = external_define(dll, "CameraZoomAll", dll_cdecl, ty_real, 1, ty_real);
	...
	global._FBORenderObject = external_define(dll, "FBORenderObject", dll_cdecl, ty_real, 2, ty_real, ty_real);
	global._FBORenderObjectEx = external_define(dll, "FBORenderObjectEx", dll_cdecl, ty_real, 6, ty_real, ty_real, ty_real, ty_real, ty_real, ty_real);
	global._FBOSetViewer = external_define(dll, "FBOSetViewer", dll_cdecl, ty_real, 2, ty_real, ty_real);
	global._FBOSetOverrideMaterial = external_define(dll, "FBOSetOverrideMaterial", dll_cdecl, ty_real, 3, ty_real, ty_real, ty_string);
	global._FBOSetColorTextureFormat = external_define(dll, "FBOSetColorTextureFormat", dll_cdecl, ty_real, 2, ty_real, ty_real);
	// firefx.pas
	...
	// polygon.pas
	global._PolygonCreate = external_define(dll, "PolygonCreate", dll_cdecl, ty_real, 1, ty_real);
	global._PolygonAddVertex = external_define(dll, "PolygonAddVertex", dll_cdecl, ty_real, 4, ty_real, ty_real, ty_real, ty_real);
	global._PolygonSetVertexPosition = external_define(dll, "PolygonSetVertexPosition", dll_cdecl, ty_real, 5, ty_real, ty_real, ty_real, ty_real, ty_real);
	global._PolygonDeleteVertex = external_define(dll, "PolygonDeleteVertex", dll_cdecl, ty_real, 2, ty_real, ty_real);
	// primitives.pas
	...
	global._ShadowMapSetCaster = external_define(dll, "ShadowMapSetCaster", dll_cdecl, ty_real, 2, ty_real, ty_real);
	global._ShadowMapSetProjectionSize = external_define(dll, "ShadowMapSetProjectionSize", dll_cdecl, ty_real, 2, ty_real, ty_real);
	global._ShadowMapSetZScale = external_define(dll, "ShadowMapSetZScale", dll_cdecl, ty_real, 2, ty_real, ty_real);
	global._ShadowMapSetZClippingPlanes = external_define(dll, "ShadowMapSetZClippingPlanes", dll_cdecl, ty_real, 3, ty_real, ty_real, ty_real);
	global._ShadowMapRender = external_define(dll, "ShadowMapRender", dll_cdecl, ty_real, 1, ty_real);
