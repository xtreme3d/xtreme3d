...
GSX3D
-----
Xtreme3D will be a fully independent game development platform! The goal of GSX3D project is creating a [GScript3](https://github.com/gecko0307/gscript3) runtime with Xtreme3D integration that allows to write games in a JavaScript-like language and compile to standalone executables. The runtime is not finished yet, please stay tuned for updates.

Documentation
-------------
Xtreme3D is fully documented in Russian, the help file is [here](https://github.com/xtreme3d/xtreme3d/tree/master/doc/ru). English translation is in progress.
